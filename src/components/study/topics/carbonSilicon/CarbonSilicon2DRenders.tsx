...
/**
 * Векторные 2D-схемы кристаллической структуры аллотропных модификаций углерода и кремния
 * с проверенной русской научной терминологией, точно выверенными углами, длинами связей
 * и аккуратным расположением элементов без наложений.
 */
export const CarbonSilicon2DRender: React.FC<CarbonSilicon2DProps> = ({
  ...
  const viewBox = isModal ? '0 0 760 430' : '0 0 300 200';
    ...
    case 'diamond':
      return (
        <svg viewBox={viewBox} className={`w-full h-full text-slate-100 ${className}`}>
          ...
          {/* Modal Header */}
          {isModal && (
            <text x="380" y="28" textAnchor="middle" fill="#f8fafc" fontSize="15" fontWeight="bold" fontFamily="sans-serif">
              Алмаз — Тетраэдрическая атомная кристаллическая решетка (sp³)
            </text>
          )}

          {/* Left Diagram Box */}
          <g transform={isModal ? 'translate(210, 215)' : 'translate(150, 100)'}>
            {/* Bonds */}
            ...
            <g transform="translate(3, 46)">
              <rect x="-26" y="-8" width="52" height="16" rx="3" fill="#0f172a" stroke="#f59e0b" strokeWidth="1" />
              <text x="0" y="4" textAnchor="middle" fill="#fbbf24" fontSize="10" fontWeight="bold" fontFamily="sans-serif">
                109°28'
              </text>
            </g>
            ...
            <text x="0" y="4" textAnchor="middle" fill="#0f172a" fontSize="11" fontWeight="extrabold" fontFamily="sans-serif">
              C
            </text>
          ...
          {isModal ? (
            <g transform="translate(460, 48)">
              <rect width="275" height="350" fill="#0f172a" rx="10" stroke="#334155" strokeWidth="1" />

              <text x="20" y="30" fill="#38bdf8" fontSize="13" fontWeight="bold" fontFamily="sans-serif">
                Кристаллографические данные:
              </text>
              <line x1="20" y1="40" x2="255" y2="40" stroke="#1e293b" strokeWidth="1" />

              <text x="20" y="68" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#f59e0b">Тип решетки:</tspan> Атомная 3D-сеть
              </text>
              <text x="20" y="96" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#f59e0b">Гибридизация C:</tspan> sp³-тетраэдр
              </text>
              <text x="20" y="124" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#fbbf24">Валентный угол:</tspan> 109°28'
              </text>
              <text x="20" y="152" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#fbbf24">Длина связи C-C:</tspan> 1.54 Å (0.154 нм)
              </text>
              <text x="20" y="180" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#38bdf8">Тип связи:</tspan> Прочные σ-связи
              </text>
              <text x="20" y="208" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#38bdf8">Твердость по Моосу:</tspan> 10 (эталон)
              </text>
              <text x="20" y="236" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
                • <tspan fontWeight="bold" fill="#94a3b8">Проводимость:</tspan> Диэлектрик
              </text>
              <text x="20" y="264" fill="#e2e8f0" fontSize="12" fontFamily="sans-serif">
      ...
      return (
        <svg viewBox={viewBox} className={`w-full h-full text-slate-100 ${className}`}>
          ...
          <g transform={isModal ? 'translate(210, 215)' : 'translate(150, 100)'}>
            ...
            {/* Layer Distance Badge (Placed on right side clear of nodes) */}
            <g transform="translate(115, -12)">
              <rect x="-10" y="-8" width="55" height="16" rx="3" fill="#0f172a" stroke="#fbbf24" strokeWidth="1" />
              <text x="17" y="4" textAnchor="middle" fill="#fbbf24" fontSize="9" fontWeight="bold" fontFamily="sans-serif">
                3.35 Å
              </text>
            </g>
    ...
    case 'fullerene':
      return (
        <svg viewBox={viewBox} className={`w-full h-full text-slate-100 ${className}`}>
          ...
          {/* Left Diagram */}
          <g transform={isModal ? 'translate(210, 215) scale(1.05)' : 'translate(150, 100) scale(0.85)'}>
            ...
            {/* Diameter badge cleanly below sphere */}
            <g transform="translate(0, 84)">
              <rect x="-35" y="-8" width="70" height="16" rx="3" fill="#0f172a" stroke="#f59e0b" strokeWidth="1" />
              <text x="0" y="4" textAnchor="middle" fill="#f59e0b" fontSize="9" fontWeight="bold" fontFamily="sans-serif">
                ⌀ ≈ 7.1 Å
              </text>
            </g>
          </g>
      ...
      return (
        <svg viewBox={viewBox} className={`w-full h-full text-slate-100 ${className}`}>
          ...
          <g transform={isModal ? 'translate(210, 215)' : 'translate(150, 100)'}>
            ...
            {/* Bond Length Badge placed in open space */}
            <g transform="translate(68, 8)">
              <rect x="-26" y="-8" width="52" height="16" rx="3" fill="#0f172a" stroke="#2dd4bf" strokeWidth="1" />
              <text x="0" y="4" textAnchor="middle" fill="#2dd4bf" fontSize="9" fontWeight="bold" fontFamily="sans-serif">
                2.35 Å
              </text>
            </g>
            ...
            <text x="0" y="4" textAnchor="middle" fill="#042f2e" fontSize="11" fontWeight="extrabold" fontFamily="sans-serif">
              Si
            </text>
          ...
          {isModal ? (
            <g transform="translate(460, 48)">
              ...
              <text x="20" y="30" fill="#2dd4bf" fontSize="13" fontWeight="bold" fontFamily="sans-serif">
