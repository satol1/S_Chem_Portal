...
/**
 * Интересные факты темы (TheoryCallout).
 * Файл хранит набор фактов; точки вставки выбираются в Sections
 * по смысловому соседству (30-DESIGN §5: равномерно по секциям, по одному).
 */
