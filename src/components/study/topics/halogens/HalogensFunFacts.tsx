...
export const HalogensFactBromineLiquid: React.FC = () => (
  <TheoryCallout title="Бром — «зловонная» жидкость">
...
export const HalogensFactIodineStarch: React.FC = () => (
  <TheoryCallout title="Иод и щитовидная железа">
...
export const HalogensFactTeflon: React.FC = () => (
  <TheoryCallout title="Тефлон — случайное открытие самого стойкого полимера">
