...
- Ролевые агенты запускаются **только самостоятельными субагентами** (именные агенты `.qwen/agents/` либо general-purpose): они стартуют с чистым контекстом и сами читают нужные модули стандарта и файлы темы по путям из задания.
