...
<div className="space-y-4 my-6">
  <TheoryCallout title="Вулканизация каучука серными мостиками">...</TheoryCallout>
  <TheoryCallout title="Парамагнетизм жидкого кислорода">...</TheoryCallout>
</div>
```
...
**Заголовок выноски — сразу название факта**, без префикса «Интересный факт: »: жёлтая скобка и иконка уже сигнализируют формат, префикс — лишние слова.
